...
function AppContent() {
  ...
  const renderHome = () => (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0">
      ...
      <a href="https://wa.me/593991234567" target="_blank" rel="noreferrer" className="fixed bottom-20 md:bottom-6 right-6 z-40 bg-green-500 text-white w-12 h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 transition-transform hover:scale-110">
