...
import { ShoppingCart, Heart, Search, Menu, X, User, TrendingUp } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative">
              <div className={`flex items-center ${searchOpen ? 'flex-1' : ''}`}>
                <div className={`relative ${searchOpen ? 'w-48 md:w-64' : ''}`}>
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all"
                  />
                  <button
